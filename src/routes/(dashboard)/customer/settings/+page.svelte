...
<div class="page">
    ...
    <div class="bg-base-100 shadow-sm rounded-md p-8 mx-auto max-w-2xl">
        ...
        <div class="info-item">
            ...
            <div class="content">
                <span class:fade={!user.state} >{ user.state?.name || "Not set" }</span>
            </div>
        </div>
        ...
        <div class="info-item">
            ...
            <div class="content">
                <span class:fade={!user.country} >{ user.country?.name || "Not set" }</span>
            </div>
        </div>

        <div class="flex py-4">
            <a href="/customer/settings/profile" class="bg-primary/5 text-primary flex items-center text-sm px-3 py-3 gap-3 rounded-md">
